...
https://dev.axiomide.com/marketplace/christiangeorgelucas/geo-encoding-tools@0.1.0
...
```bash
axiom invoke christiangeorgelucas/geo-encoding-tools/GeohashEncode --input '{ ... }'
```

**Call it over HTTP.**

```bash
curl -X POST https://api.axiomide.com/invocations/v1/nodes/christiangeorgelucas/geo-encoding-tools/0.1.0/GeohashEncode \
...
> `axiom inspect node christiangeorgelucas/geo-encoding-tools/GeohashEncode`.
